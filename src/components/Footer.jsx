...
const Footer = () => {
  return (
    <footer class="w-full bg-gray-100 py-20 px-16">
      <div class="mx-auto max-w-7xl flex max-md:flex-col md:justify-between">
        ...
        <div class="max-md:mb-16 self-center md:self-stretch ">
